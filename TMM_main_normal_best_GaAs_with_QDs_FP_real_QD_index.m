...
n(4,:)=retindice_semicond(lambda*1e6,81.1);
n(5,:)=retindice_semicond(lambda*1e6,40);
n(6,:)=retindice_semicond(lambda*1e6,81.1);
n(7,:)=retindice_semicond(lambda*1e6,40);
n(8,:)=retindice_semicond(lambda*1e6,81.1);
n(9,:)=retindice_semicond(lambda*1e6,40);
n(10,:)=retindice_semicond(lambda*1e6,81.1);
n(11,:)=retindice_semicond(lambda*1e6,40);
n(12,:)=retindice_semicond(lambda*1e6,81.1);
n(13,:)=retindice_semicond(lambda*1e6,40);
n(14,:)=retindice_semicond(lambda*1e6,81.1);
n(15,:)=retindice_semicond(lambda*1e6,40);
n(16,:)=retindice_semicond(lambda*1e6,81.1);
n(17,:)=retindice_semicond(lambda*1e6,40);
n(18,:)=retindice_semicond(lambda*1e6,81.1);
n(19,:)=retindice_semicond(lambda*1e6,40);
n(20,:)=retindice_semicond(lambda*1e6,81.1);
